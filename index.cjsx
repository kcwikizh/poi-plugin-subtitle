...
module.exports =
  pluginDidLoad: (e) ->
    ...
    webview.addEventListener 'did-get-response-details', handleResponseDetail
  pluginWillUnload: (e) ->
    window.removeEventListener 'game.response', handleGameResponse
    webview.removeEventListener 'did-get-response-details', handleResponseDetail
  show: false
